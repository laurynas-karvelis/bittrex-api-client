...
class PublicApi {
    ...
    getOrderBook(market, depth = 20, type = 'both') {
        const promise = this._request('public/getorderbook', {market, depth, type});
        return config.useResponseAdapters ? promise.then(responseAdapters.OrderBook) : promise;
    }
